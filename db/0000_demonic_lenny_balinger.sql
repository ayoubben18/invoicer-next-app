...
-- CREATE UNIQUE INDEX "bname" ON "storage"."buckets" USING btree ("name" text_ops);--> statement-breakpoint
...
-- CREATE UNIQUE INDEX "bucketid_objname" ON "storage"."objects" USING btree ("bucket_id" text_ops,"name" text_ops);--> statement-breakpoint
-- CREATE INDEX "idx_objects_bucket_id_name" ON "storage"."objects" USING btree ("bucket_id" text_ops,"name" text_ops);--> statement-breakpoint
-- CREATE INDEX "name_prefix_search" ON "storage"."objects" USING btree ("name" text_pattern_ops);--> statement-breakpoint
...
-- CREATE INDEX "idx_multipart_uploads_list" ON "storage"."s3_multipart_uploads" USING btree ("bucket_id" timestamptz_ops,"key" text_ops,"created_at" timestamptz_ops);--> statement-breakpoint
...
-- CREATE UNIQUE INDEX "confirmation_token_idx" ON "auth"."users" USING btree ("confirmation_token") WHERE ((confirmation_token)::text !~ '^[0-9 ]*$'::text);--> statement-breakpoint
-- CREATE UNIQUE INDEX "email_change_token_current_idx" ON "auth"."users" USING btree ("email_change_token_current") WHERE ((email_change_token_current)::text !~ '^[0-9 ]*$'::text);--> statement-breakpoint
-- CREATE UNIQUE INDEX "email_change_token_new_idx" ON "auth"."users" USING btree ("email_change_token_new") WHERE ((email_change_token_new)::text !~ '^[0-9 ]*$'::text);--> statement-breakpoint
-- CREATE UNIQUE INDEX "reauthentication_token_idx" ON "auth"."users" USING btree ("reauthentication_token") WHERE ((reauthentication_token)::text !~ '^[0-9 ]*$'::text);--> statement-breakpoint
-- CREATE UNIQUE INDEX "recovery_token_idx" ON "auth"."users" USING btree ("recovery_token") WHERE ((recovery_token)::text !~ '^[0-9 ]*$'::text);--> statement-breakpoint
-- CREATE UNIQUE INDEX "users_email_partial_key" ON "auth"."users" USING btree ("email") WHERE (is_sso_user = false);--> statement-breakpoint
